...
while True:
    ...
    if user_choice == 'exchange':
        ...
        if user_choice_way == 'save':
            ...
            if user_choice_way2 == 'raise':
                print('\nGreat! Laban accepted the offer and handed over the plates, now you can return to your father\'s tent ')
    ...
    if user_choice == 'disguise':
        ...
        if user_choice_way2 == 'run':
                print('\nWell done! You got the plates in time before Laban returned. Congratulations, now you can go back to your father\'s tent. ')
                break    
        if user_choice_way2 == 'send':
                ...
                if user_choice_way3 == 'sword':
                    print('\nZoran the servant is scared. You reassured him, you took the plates, and now you and he will return to your father\'s tent.')
                    break
                if user_choice_way3 == 'imitate':
                    ...
                    if user_choice_way4 == 'polite':
                        ...
                        if user_choice_way5 == 'hide':
                            ...
                            if user_choice_way6 == 'window':
                                ...
                                break
                            if user_choice_way6 == 'fight':
                                print('\nAlone against all those guards, it would be impossible to win, wouldn\'t it? You were caught by the guards. Game Over')
                                break
                            else:
                                print("\nLet's try again, please, type: WINDOW or FIGHT\n")
                        else:
                            print("\nLet's try again, please, type: ESCAPE or HIDE\n")
                    else:
                        print("\nLet's try again, please, type: SEVERE or POLITE\n")
                else:
                    print("\nLet's try again, please, type: SWORD or IMITATE\n")
            
            #4th way
                if user_choice_way2 == 'enjoy':
                    print('You wasted a lot of time and Laban came home, the guards arrested you. Game over')
                    break
    else:
        print("\nLet's try again, please, type: RUN, SEND or ENJOY\n")
