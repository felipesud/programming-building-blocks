...
print('01 - Use a for loop to iterate through this list one by one and display each item on its own line')
...
#03 - Use a for loop to display the even numbers (hint: count by two) 2–20, one number on each line 
print('\n03 - Use a for loop to display the even numbers (hint: count by two) 2–20, one number on each line ')
